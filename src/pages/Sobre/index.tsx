  ...
  return (
    <MenuBar>
      <section className="flex flex-col justify-center items-center p-3">
        ...
        <NavLink className="bg-[#FFBD59] p-3 rounded-lg font-semibold mt-4 hover:cursor-pointer hover:scale-105 duration-150" to="/doacao"><a>Clique aqui para doar!</a></NavLink>
