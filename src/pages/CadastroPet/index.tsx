          ...
          <div className="flex flex-wrap w-full justify-center">
            <div className="flex flex-col items-start flex-1">
              ...
              <input
                ...
                className="border-solid border-2 border-black rounded-sm p-2 m-2"
                onChange={(e) => handleChange(e)}
              />
            </div>
            <div className="flex flex-col items-start flex-1">
              ...
              <select
                name="especie"
                defaultValue=""
                className="border-solid border-2 border-black rounded-sm p-2 m-2 w-full"
                onChange={(e) => handleChange(e)}
              >
                <option value="" disabled>
                  Escolha uma opção...
          ...
          <div className="flex flex-wrap w-full justify-center">
            ...
            <div className="flex flex-col items-start flex-1">
              ...
              <input
                ...
                className="border-solid border-2 border-black rounded-sm p-2 duration-150 m-2 w-full "
                onChange={(e) => handleChange(e)}
              />
            </div>
          </div>
